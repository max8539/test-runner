...
test-runner.js is a script which can be used to automate testing of programs. It was originally made to help test small programs written in C, however it can be used to test programs written in many programming languages, as long as your program can be started by entering a terminal command.

test-runner.js is primarily aimed at development in programming languages that don't have a native testing framework. If the programming language you are using has a native/third party testing framework specific to that programming language, you may find that more useful.

One of the main goals of test-runner.js was to make it portable and as user-friendly to non-JavaScript developers as possible. As such, test-runner.js has 0 external dependencies, using only Node.js built-in modules, and does not require npm or other package managers to be used.
...
**WARNING:** Be careful not to accidentally add files from other projects to the test-runner.js repository. While the `.gitignore` file should prevent other files from being added automatically if it is there, you should double check the files you are commiting before you make the commit. It is extremely difficult, if not impossible, to remove references to a file in Git's history once a commit has been made, especially if you have pushed that commit to an online repository.
...
_[2.1 - Summary of Configuration Attributes](#21---summary-of-configuration-attributes)_  
_[2.2 - Verbosity Settings](#22---verbosity-settings)_  
_[2.3 - Build Commands](#23---build-commands)_  
_[2.4 Run All Tests, or Stop when a Test Fails](#24-run-all-tests--or-stop-when-a-test-fails)_  
_[2.5 Returning the Final Score as the Exit Code](#25-returning-the-final-score-as-the-exit-code)_  
_[2.6 - Specifying Your Tests](#26---specifying-your-tests)_  
_[2.7 - Example `testconfig.json` file](#27---example--testconfigjson--file)_  
**[3 - Writing Your Tests](#3---writing-your-tests)**  
_[3.1 - Summary of Test Object Attributes](#31---summary-of-test-object-attributes)_  
_[3.2 - Naming Your Test](#32---naming-your-test)_  
_[3.3 - Expecting an Error from Your Program](#33---expecting-an-error-from-your-program)_  
_[3.4 - Run Commands Before Running Your Program](#34---run-commands-before-running-your-program)_  
_[3.5 - Running Your Program](#35---running-your-program)_  
_[3.6 - Setting a Timeout for Your Program](#36---setting-a-timeout-for-your-program)_  
_[3.7 - Specify Input for Your Program](#37---specify-input-for-your-program)_  
_[3.8 - Specify Expected Output from Your Program](#38---specify-expected-output-from-your-program)_  
_[3.9 - Specify Expected Error Output from Your Program](#39---specify-expected-error-output-from-your-program)_  
_[3.10 - Specify Files to be Checked](#310---specify-files-to-be-checked)_  
_[3.11 - Run Commands After Running Your Program](#311---run-commands-after-running-your-program)_  
_[3.12 - Skip a Test](#312---skip-a-test)_  
_[3.13 - Example Test Object](#313---example-test-object)_  
_[3.14 - Order of Test Checks](#314---order-of-test-checks)_  
**[4 - Running and Troubleshooting](#4---running-and-troubleshooting)**  
_[4.1 - Running test-runner.js](#41---running-test-runnerjs)_  
_[4.2 - Troubleshooting Error Messages](#42---troubleshooting-error-messages)_  
_[4.3 - Other Troubleshooting](#43---other-troubleshooting)_
...
Attribute: `"skip"` (optional, default: `false`)

Set `"skip"` to `true` to skip this test and continue on to the next test. No commands or checks for this test will be run. This can be useful if you want to temporarily skip a test while you write your program.

### 3.13 - Example Test Object
